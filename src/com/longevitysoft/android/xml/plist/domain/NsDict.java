 ...
 * @author fbeachler
 */
public class NsDict extends PListObject {
	...
	public <E extends PListObject> E getConfigurationObject(java.lang.String key) {
		...
		if (st.hasMoreTokens()) {
			...
			while (st.hasMoreTokens()) {
				...
				obj = dict.get(token);
				if (obj instanceof NsDict) {
					dict = ((NsDict) obj).getConfigMap();
					continue;
				}
				return (E) obj;
			}
	 ...
	 */
	public NsString getConfiguration(java.lang.String key) {
		return (NsString) getConfigurationObject(key);
	}
	 ...
	 */
	public NsString getConfigurationWithDefault(java.lang.String key,
			NsString defaultValue) {
		NsString value = getConfiguration(key);
		if (value == null) {
			return defaultValue;
		}
	 ...
	 */
	public NsInteger getConfigurationInteger(java.lang.String key) {
		return (NsInteger) getConfigurationObject(key);
	}
	 ...
	 *         value for keyName is null.
	 */
	public NsInteger getConfigurationIntegerWithDefault(java.lang.String key,
			NsInteger defaultValue) {
		NsInteger value = getConfigurationInteger(key);
		if (value == null) {
			return defaultValue;
		}
	 ...
	 * @return The Integer value of the specified key.
	 */
	public NsArray getConfigurationArray(java.lang.String key) {
		return (NsArray) getConfigurationObject(key);
	}
